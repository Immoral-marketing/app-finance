...
async function ensureCategories() {
    console.log('Ensuring all expense categories exist...');
    ...
    // Insert missing
    // We need to assign them a parent category or just leave as top level?
    // For simplicity, top level. But 'is_general' might be useful?
    // Let's just insert name and make sure code is unique-ish? Or let DB allow dupes if constraint allows?
    // Schema usually has name + code. We'll generate a code.
